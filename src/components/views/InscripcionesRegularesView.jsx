...
import { InscripcionesRegulares } from "../../test/DatosPrueba";

const InscripcionesRegularesView = () => {
...
//   };
  ...
  useEffect(() => {
    // fetchInscripciones();
    setInscripciones(InscripcionesRegulares);
    setLoading(false);
  }, []);
  ...
  return (
    <ListView title="Lista de Inscripciones Regulares">
      {loading ? (
...
export default InscripcionesRegularesView;
